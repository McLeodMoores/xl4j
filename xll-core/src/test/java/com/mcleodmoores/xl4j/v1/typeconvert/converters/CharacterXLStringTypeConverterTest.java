...
import com.mcleodmoores.xl4j.v1.typeconvert.converters.CharacterXLStringTypeConverter;
import com.mcleodmoores.xl4j.v1.util.XL4JRuntimeException;

/**
 * Unit tests for {@link CharacterXLStringTypeConverter}.
 */
@Test
public class CharacterXLStringTypeConverterTest {
  /** The converter. */
  private static final AbstractTypeConverter CONVERTER = new CharacterXLStringTypeConverter();
  ...
  public void testGetExcelToJavaTypeMapping() {
    assertEquals(CONVERTER.getExcelToJavaTypeMapping(), ExcelToJavaTypeMapping.of(XLString.class, Character.class));
  }
  ...
  public void testGetJavaToExcelTypeMapping() {
    assertEquals(CONVERTER.getJavaToExcelTypeMapping(), JavaToExcelTypeMapping.of(Character.class, XLString.class));
  }
  ...
  public void testNullXLValue() {
    CONVERTER.toJavaObject(Character.class, null);
  }
  ...
  public void testWrongTypeToJavaConversion() {
    CONVERTER.toJavaObject(Character.class, XLBoolean.FALSE);
  }
  ...
  public void testStringTooLong() {
    CONVERTER.toJavaObject(Character.class, XLString.of("abc"));
  }
  ...
  public void testWrongExpectedClassToJavaConversion() {
    assertEquals(CONVERTER.toJavaObject(Integer.class, XLString.of("a")), 'a');
  }
  ...
  public void testConversionFromXLString() {
    ...
    final Character cha = (Character) converted;
    assertEquals(cha, Character.valueOf('a'));
  }
}
