...
import com.mcleodmoores.xl4j.typeconvert.converters.LongXLStringTypeConverter;
...
/**
 * Unit tests for {@link LongXLStringTypeConverter}.
 */
@Test
public class LongXLStringTypeConverterTest {
  /** The converter. */
  private static final AbstractTypeConverter CONVERTER = new LongXLStringTypeConverter();
  ...
  public void testGetExcelToJavaTypeMapping() {
    assertEquals(CONVERTER.getExcelToJavaTypeMapping(), ExcelToJavaTypeMapping.of(XLString.class, Long.class));
  }
  ...
  public void testGetJavaToExcelTypeMapping() {
    assertEquals(CONVERTER.getJavaToExcelTypeMapping(), JavaToExcelTypeMapping.of(Long.class, XLString.class));
  }
  ...
  public void testNullObject() {
    CONVERTER.toXLValue(Long.class, null);
  }
  ...
  public void testWrongTypeToJavaConversion() {
    CONVERTER.toJavaObject(Long.class, XLBoolean.FALSE);
  }
  ...
  public void testConversionFromXLString() {
    final Object converted = CONVERTER.toJavaObject(Long.class, XLString.of(Long.valueOf(3L).toString()));
