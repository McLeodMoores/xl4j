...
import com.mcleodmoores.xl4j.typeconvert.converters.FloatXLStringTypeConverter;
...
/**
 * Unit tests for {@link FloatXLStringTypeConverter}.
 */
@Test
public class FloatXLStringTypeConverterTest {
  /** The converter. */
  private static final AbstractTypeConverter CONVERTER = new FloatXLStringTypeConverter();
  ...
  public void testGetExcelToJavaTypeMapping() {
    assertEquals(CONVERTER.getExcelToJavaTypeMapping(), ExcelToJavaTypeMapping.of(XLString.class, Float.class));
  }
  ...
  public void testGetJavaToExcelTypeMapping() {
    assertEquals(CONVERTER.getJavaToExcelTypeMapping(), JavaToExcelTypeMapping.of(Float.class, XLString.class));
  }
  ...
  public void testNullObject() {
    CONVERTER.toXLValue(Float.class, null);
  }
  ...
  public void testWrongTypeToJavaConversion() {
    CONVERTER.toJavaObject(Float.class, XLBoolean.FALSE);
  }
  ...
  public void testConversionFromXLString() {
    final Object converted = CONVERTER.toJavaObject(Float.class, XLString.of(Float.valueOf(3f).toString()));
