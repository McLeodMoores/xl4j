...
import com.mcleodmoores.xl4j.typeconvert.converters.ShortXLStringTypeConverter;
...
/**
 * Unit tests for {@link ShortXLStringTypeConverter}.
 */
@Test
public class ShortXLStringTypeConverterTest {
  /** The converter. */
  private static final AbstractTypeConverter CONVERTER = new ShortXLStringTypeConverter();
  ...
  public void testGetExcelToJavaTypeMapping() {
    assertEquals(CONVERTER.getExcelToJavaTypeMapping(), ExcelToJavaTypeMapping.of(XLString.class, Short.class));
  }
  ...
  public void testGetJavaToExcelTypeMapping() {
    assertEquals(CONVERTER.getJavaToExcelTypeMapping(), JavaToExcelTypeMapping.of(Short.class, XLString.class));
  }
  ...
  public void testNullExpectedXLValueClass() {
    CONVERTER.toXLValue(null, (short) 3);
  }
  ...
  public void testNullObject() {
    CONVERTER.toXLValue(Short.class, null);
  }
  ...
  public void testWrongTypeToJavaConversion() {
    CONVERTER.toJavaObject(Short.class, XLBoolean.FALSE);
  }
  ...
  public void testWrongTypeToXLConversion() {
    CONVERTER.toXLValue(XLString.class, Long.valueOf(10));
  }
  ...
  public void testWrongExpectedClassToXLConversion() {
    assertEquals(CONVERTER.toXLValue(XLInteger.class, (short) 4), XLString.of("4"));
  }
  ...
  public void testConversionFromShort() {
    final XLValue converted = (XLValue) CONVERTER.toXLValue(XLString.class, (short) 2);
  ...
  public void testConversionFromXLString() {
    final Object converted = CONVERTER.toJavaObject(Short.class, XLString.of(Short.valueOf((short) 3).toString()));
