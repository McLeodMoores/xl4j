 ...
 */
public final class PrimitiveCharArrayXLArrayTypeConverter extends AbstractTypeConverter {
  /** The Excel context */
   ...
   */
  public PrimitiveCharArrayXLArrayTypeConverter(final Excel excel) {
    super(char[].class, XLArray.class);
  ...
  public Object toJavaObject(final Type expectedType, final Object from) {
    ...
    if (arr.length == 1) { // array is a single row
      final char[] targetArr = new char[arr[0].length];
      for (int i = 0; i < arr[0].length; i++) {
        ...
        targetArr[i] = (char) lastConverter.toJavaObject(componentType, val);
      }
      return targetArr;
    }
