...
/**
 * Some common utility methods for reflection-based operations. Called XL4JReflectionUtils so it didn't clash with ReflectionUtils of the
 * Reflections framework.
 */
public final class XL4JReflectionUtils {
  private XL4JReflectionUtils() {
  }
  ...
  public static Class<?> reduceToClass(final Type type) {
    if (type instanceof Class) {
      ...
      throw new XL4JRuntimeException("This shouldn't be reached for type " + type);
    }
  }
