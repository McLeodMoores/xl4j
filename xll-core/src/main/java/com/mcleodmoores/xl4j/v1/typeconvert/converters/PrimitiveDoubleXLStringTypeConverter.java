 ...
 */
public final class PrimitiveDoubleXLStringTypeConverter extends AbstractTypeConverter {
  /** The priority */
   ...
   * Default constructor.
   */
  public PrimitiveDoubleXLStringTypeConverter() {
    super(Double.TYPE, XLString.class, PRIORITY);
  }
  ...
  public Object toJavaObject(final Type expectedType, final Object from) {
    ArgumentChecker.notNull(from, "from");
    return Double.parseDouble(((XLString) from).getValue());
  }
}
