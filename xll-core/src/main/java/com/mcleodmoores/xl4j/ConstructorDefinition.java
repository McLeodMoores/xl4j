...
public final class ConstructorDefinition {
   ...
   *          the export number
   */
  private ConstructorDefinition(final ConstructorMetadata constructorMetadata, final ConstructorInvoker constructorInvoker,
   ...
   */
  public static ConstructorDefinition of(final ConstructorMetadata constructorMetadata, final ConstructorInvoker constructorInvoker,
      final int exportNumber) {
