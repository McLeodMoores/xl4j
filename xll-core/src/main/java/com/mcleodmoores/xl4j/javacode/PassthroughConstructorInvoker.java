    ...
    try {
      if (_constructor.isVarArgs()) {
        if (arguments.length == 0) {
          ...
          if (varArgType == null) {
            throw new Excel4JRuntimeException("Error instantiating constructor: last argument for varargs method was not an array");
          }
      ...
      throw new Excel4JRuntimeException("Error instantiating constructor", e);
    }
  }
