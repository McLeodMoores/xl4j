...
public class PrimitiveShortArrayXLArrayTypeConverterTest {
  ...
  /** The converter. */
  private static final AbstractTypeConverter CONVERTER = new PrimitiveShortArrayXLArrayTypeConverter(EXCEL);
  ...
  public void testExpectedTypeNotAnArray() {
    CONVERTER.toXLValue(XLInteger.class, new short[] {10, 20});
  }
