 ...
 */
public final class ArrayExcelToJavaTypeMapping implements ExcelToJavaTypeMapping<XLValue[], Type> {
   ...
   */
  private ArrayExcelToJavaTypeMapping(final Class<? extends XLValue[]> excelType, final Type javaType) {
   ...
   * @return an instance
   */
  public static ArrayExcelToJavaTypeMapping of(final Class<? extends XLValue[]> excelType, final Type javaType) {
    return new ArrayExcelToJavaTypeMapping(excelType, javaType);
  }
  ...
  public String toString() {
    return "ArrayExcelToJavaTypeMapping[excelType=" + _excelType + ", javaType=" + _javaType + "]";
  }
