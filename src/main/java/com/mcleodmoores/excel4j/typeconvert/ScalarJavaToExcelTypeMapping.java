 ...
 */
public final class ScalarJavaToExcelTypeMapping implements JavaToExcelTypeMapping<Type, XLValue> {
   ...
   */
  private ScalarJavaToExcelTypeMapping(final Type javaType, final Class<? extends XLValue> excelType) {
   ...
   * @return an instance
   */
  public static ScalarJavaToExcelTypeMapping of(final Type javaType, final Class<? extends XLValue> excelType) {
    return new ScalarJavaToExcelTypeMapping(javaType, excelType);
  }
  ...
  public String toString() {
    return "ScalarJavaToExcelTypeMapping[excelType=" + _excelType + ", javaType=" + _javaType + "]";
  }
}
