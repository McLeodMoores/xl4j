...
/**
 * Type converter to convert from arrays of longs to Excel arrays and back again. The input
 * array from Excel can contain any type of {@link XLValue} (e.g. <code>XLNumber</code>,
 * <code>XLString("1L")</code>) and an attempt will be made to convert this value to a long.
 */
public final class PrimitiveLongArrayXLArrayTypeConverter extends AbstractTypeConverter {
   ...
   */
  public PrimitiveLongArrayXLArrayTypeConverter(final Excel excel) {
  ...
  public Object toJavaObject(final Type expectedType, final Object from) {
    ...
    if (arr.length == 1) { // array is a single row
      ...
      for (int i = 0; i < arr[0].length; i++) {
        ...
        targetArr[i] = (long) lastConverter.toJavaObject(componentType, val);
      }
      return targetArr;
    }
