...
HRESULT CScanExecutor::Run (JNIEnv *pEnv) {
	...
	try {
		...
		jclass jcXLLAccumulatingFunctionRegistry = pEnv->FindClass ("com/mcleodmoores/xl4j/v1/xll/XLLAccumulatingFunctionRegistry");
		jmethodID jmXLLAccumulatingFunctionRegistry_GetEntries = pEnv->GetMethodID (jcXLLAccumulatingFunctionRegistry, "getEntries", "()[Lcom/mcleodmoores/xl4j/v1/xll/XLLAccumulatingFunctionRegistry$LowLevelEntry;");
		...
		jclass jcLowLevelEntry = pEnv->FindClass ("com/mcleodmoores/xl4j/v1/xll/XLLAccumulatingFunctionRegistry$LowLevelEntry");
