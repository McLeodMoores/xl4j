...
void JniCache::Init (JNIEnv *pEnv) {
	...
	m_jmXLSheetId_of = pEnv->GetStaticMethodID (m_jcXLSheetId, "of", "(I)Lcom/mcleodmoores/xl4j/values/XLSheetId;");
	m_jcXLRange = (jclass) pEnv->NewGlobalRef (pEnv->FindClass ("com/mcleodmoores/xl4j/values/XLRange"));
	...
	jfieldID jfValue = pEnv->GetStaticFieldID (m_jcXLError, "Value", "Lcom/mcleodmoores/xl4j/values/XLError;");
	jfieldID jfRef = pEnv->GetStaticFieldID (m_jcXLError, "Ref", "Lcom/mcleodmoores/xl4j/values/XLError;");
	...
	m_jmXLArray_of = pEnv->GetStaticMethodID (m_jcXLArray, "of", "([[Lcom/mcleodmoores/xl4j/values/XLValue;)Lcom/mcleodmoores/xl4j/values/XLArray;");
	...
	jfieldID jfMissingInstance = pEnv->GetStaticFieldID (m_jcXLMissing, "INSTANCE", "Lcom/mcleodmoores/xl4j/values/XLMissing;");
	...
	m_jmXLMultiReference_getRangesArray = pEnv->GetMethodID (m_jcXLMultiReference, "getRangesArray", "()[Lcom/mcleodmoores/xl4j/values/XLRange;");
	...
	m_jmXLLocalReference_getRange = pEnv->GetMethodID (m_jcXLLocalReference, "getRange", "()Lcom/mcleodmoores/xl4j/values/XLRange;");
	...
	m_jmXLArray_getArray = pEnv->GetMethodID (m_jcXLArray, "getArray", "()[[Lcom/mcleodmoores/xl4j/values/XLValue;");

	jclass jcExcelFactory = pEnv->FindClass ("com/mcleodmoores/xl4j/ExcelFactory");
	jmethodID jmExcelFactory_getInstance = pEnv->GetStaticMethodID (jcExcelFactory, "getInstance", "()Lcom/mcleodmoores/xl4j/Excel;");
	jclass jcExcelFunctionCallHandler = pEnv->FindClass ("com/mcleodmoores/xl4j/ExcelFunctionCallHandler");
	...
	jmethodID jmExcel_getHeap = pEnv->GetMethodID (jcExcel, "getHeap", "()Lcom/mcleodmoores/xl4j/heap/Heap;");
