========================================================================
    ACTIVE TEMPLATE LIBRARY : rtd-server Project Overview
========================================================================

AppWizard has created this rtd-server project for you to use as the starting point for
...
rtdserver.idl
    ...
    This file will be processed by the MIDL compiler to generate:
        C++ interface definitions and GUID declarations (rtdserver.h)
        GUID definitions                                (rtdserver_i.c)
        A type library                                  (rtdserver.tlb)
        Marshaling code                                 (rtdserver_p.c and dlldata.c)

rtdserver.h
    This file contains the C++ interface definitions and GUID declarations of the
    items defined in rtdserver.idl. It will be regenerated by MIDL during compilation.
...
StdAfx.h, StdAfx.cpp
    ...
    named rtd-server.pch and a precompiled types file named StdAfx.obj.
...
rtd-serverps.vcxproj
	...
	dlldata.c, rtdserver_i.c and rtdserver_p.c which are required
	to build the proxy/stub DLL.

rtd-serverps.vcxproj.filters
