...
//			long lXLNumberRef = pHelper->CallStaticMethod (JTYPE_OBJECT, TEXT ("com/mcleodmoores/xl4j/v1/api/values/XLNumber"), TEXT ("of"), TEXT ("(D)Lcom/mcleodmoores/xl4j/v1/api/values/XLNumber;"), 1, lDoubleRef);
//			long lIntegerRef = pHelper->NewObject (TEXT ("java/lang/Integer"), TEXT ("(I)V"), 1, pHelper->IntegerConstant (6));
//			long lValueRef = pHelper->CallMethod (JTYPE_DOUBLE, lXLNumberRef, pHelper->GetMethodID (TEXT ("com/mcleodmoores/xl4j/v1/api/values/XLNumber"), TEXT ("getValue"), TEXT ("()D")), 0);
