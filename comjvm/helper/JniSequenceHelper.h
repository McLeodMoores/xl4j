...
public:
	...
	long NewObjectArray (long lClassRef, int length);
	long NewObjectArray (TCHAR *cls, int length);
	long NewObjectArray (long lClassRef, long lArrayClassRef, int length, int width);
