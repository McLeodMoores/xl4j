...
public final class JUtils {
  ...
  public static XLValue after(
      @XLArgument(name = "before", description = "cell to calculate before") final XLValue before,
      @XLArgument(name = "after", description = "value to calculate after") final XLValue after) {
    return after;
  }
