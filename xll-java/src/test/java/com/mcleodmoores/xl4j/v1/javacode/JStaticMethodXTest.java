...
public class JStaticMethodXTest {
  ...
  public void testNoMethod() {
    final Object methodResult = JMethod.jStaticMethodX(XLString.of("java.lang.StringBuilder"), XLString.of("noMethodCalledThis"), new XLValue[0]);
  ...
  public void testWrongNumberOfArguments() {
    final Object methodResult = JMethod.jStaticMethodX(XLString.of("java.lang.Math"), XLString.of("cos"), XLNumber.of(10), XLNumber.of(20));
    assertSame(methodResult, XLError.Null);
  }
  ...
  public void testWrongTypeOfArguments() {
    final Object methodResult = JMethod.jStaticMethodX(XLString.of("java.lang.Math"), XLString.of("cos"), XLString.of("A"));
    assertSame(methodResult, XLError.Null);
  }
  ...
  public void testWrongClassName() {
    final Object methodResult = JMethod.jStaticMethodX(XLString.of("java.util.Math"), XLString.of("cos"), XLNumber.of(10));
    assertSame(methodResult, XLError.Null);
  }
