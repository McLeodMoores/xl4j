...
public final class ScheduleAdjusterV2 {
  ...
  public static ScheduleAdjusterV2 of(
      @XLParameter(name = "schedule") final Schedule schedule) {
    return new ScheduleAdjusterV2(schedule);
  }

  private final Schedule _schedule;

  private ScheduleAdjusterV2(final Schedule schedule) {
