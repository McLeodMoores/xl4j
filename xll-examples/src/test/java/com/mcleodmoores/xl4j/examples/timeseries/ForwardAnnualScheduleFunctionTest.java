...
/**
 * Unit tests for {@link ForwardAnnualScheduleFunction}.
 */
public class ForwardAnnualScheduleFunctionTest {
  private static final BiFunction<LocalDate, LocalDate, Schedule> FUNCTION = new ForwardAnnualScheduleFunction();
